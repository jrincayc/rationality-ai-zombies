...
Hanson:\footnoteA{Robin Hanson, ``You Are Never Entitled to Your
Opinion,'' \textit{Overcoming Bias (blog)} (2006),
http://www.overcomingbias.com/2006/12/you\_are\_never\_e.html.\comment{1}}}
...
answer is still 1:5.\footnoteA{This follows from the assumption that there are six
...
they were \textit{seeing}.\footnoteA{Albert Hastorf and Hadley Cantril, ``They Saw
a Game: A Case Study,'' \textit{Journal of Abnormal
and Social Psychology} 49 (1954): 129--134,
http://www2.psych.ubc.ca/\~{}schaller/Psyc590Readings/Hastorf1954.pdf.\comment{3}}}
...
perceptions rally to their defense.\footnoteA{Pronin, ``How We See Ourselves and How We See
Others.''\comment{4}}\footnoteA{Robert P. Vallone, Lee Ross, and Mark R. Lepper,
...
http://ssc.wisc.edu/\~{}jpiliavi/965/hwang.pdf.\comment{5}} Some
...
\textit{specifically} to help us win arguments.\footnoteA{Hugo Mercier and Dan Sperber, ``Why Do Humans
Reason? Arguments for an Argumentative Theory,''
\textit{Behavioral and Brain Sciences} 34 (2011): 57--74,
https://hal.archives-ouvertes.fr/file/index/docid/904097/filename/MercierSperberWhydohumansreason.pdf.\comment{6}}}
...
models.\footnoteA{Richard E. Nisbett and Timothy D. Wilson,
``Telling More than We Can Know: Verbal Reports on
Mental Processes,'' \textit{Psychological Review} 84
(1977): 231--259,
http://people.virginia.edu/\~{}tdw/nisbett\&wilson.pdf.\comment{7}}\footnoteA{Eric Schwitzgebel, \textit{Perplexities of Consciousness} (MIT
...
arrived at the belief.\footnoteA{Jonathan Haidt, ``The Emotional Dog and Its
...
Scott Alexander observed:\footnoteA{Scott Alexander, ``Why I Am Not Rene
Descartes,'' \textit{Slate Star Codex (blog)} (2014),
http://slatestarcodex.com/2014/11/27/why-i-am-not-rene-descartes/.\comment{10}}}
...
Agency:\footnoteA{Luke Muehlhauser, ``The Power of
Agency,'' \textit{Less Wrong (blog)} (2011),
http://lesswrong.com/lw/5i8/the\_power\_of\_agency/.\comment{11}}}
...
proof.''\footnoteA{John Kenneth Galbraith, \textit{Economics, Peace and Laughter}
...
Sling}\footnoteA{Marc Stiegler, \textit{David's Sling} (Baen,
1988).\comment{1}}
\par}
...
bold:\footnoteA{Iain Banks, \textit{The Player of Games} (Orbit, 1989).\comment{2}}}
...
Relativity of Wrong'':\footnoteA{Isaac Asimov, \textit{The Relativity of Wrong} (Oxford
...
overall good or bad feeling about the technology.\footnoteA{Melissa L. Finucane et al., ``The Affect
...
{\raggedleft
 {}---Gilbert and Malone\footnoteA{Daniel T. Gilbert and Patrick S. Malone, ``The
Correspondence Bias,'' \textit{Psychological
Bulletin} 117, no. 1 (1995): 21--38,
http://www.wjh.harvard.edu/\~{}dtg/Gilbert\%20\&\%20Malone\%20(CORRESPONDENCE\%20BIAS).pdf.\comment{1}}
\par}
...
direction randomly assigned.\footnoteA{Edward E. Jones and Victor A. Harris, ``The
Attribution of Attitudes,'' \textit{Journal of
Experimental Social Psychology} 3 (1967): 1--24,
http://www.radford.edu/\~{}jaspelme/443/spring-2007/Articles/Jones\_n\_Harris\_1967.pdf.\comment{2}}}
...
{\raggedleft
 {}---H. Beam Piper, \textit{Police Operation}\footnoteA{Henry Beam Piper, ``Police
...
it dark out.''\footnoteA{Robert M. Pirsig, \textit{Zen and the Art of Motorcycle
...
Systems: Networks of Plausible Inference}\footnoteA{Pearl, \textit{Probabilistic Reasoning in Intelligent
Systems}.\comment{1}} and
\textit{Causality: Models, Reasoning, and
Inference}.\footnoteA{Judea Pearl, \textit{Causality: Models, Reasoning, and
...
the ball.''\footnoteA{Jerry Cleaver, \textit{Immediate Fiction: A Complete Writing
...
and the English Language.\footnoteA{George Orwell, ``Politics and the English
...
conjugate strands of DNA:\footnoteA{Ibid.\comment{1}}}
...
Winston to admit that two plus two equals five:\footnoteA{George Orwell, \textit{1984} (Signet Classic, 1950).\comment{2}}}
...
describes the confirmation of six predictions:\footnoteA{Charles S. Taber and Milton Lodge, ``Motivated
Skepticism in the Evaluation of Political Beliefs,''
...
{\raggedleft
 {}---Eugene Gendlin\footnoteA{Eugene T. Gendlin, \textit{Focusing} (Bantam Books, 1982).\comment{1}}
\par}
...
{\raggedleft
 {}---\textit{First Lensman}\footnoteA{Edward Elmer Smith and A. J. Donnell, \textit{First Lensman}
...
{\raggedleft
 {}---\textit{Gray Lensman}\footnoteA{Edward Elmer Smith and Ric Binkley, \textit{Gray Lensman} (Old
...
m/s\footnoteA{Edward Elmer Smith and Ric Binkley, \textit{Gray Lensman} (Old
Earth Books, 1998).\comment{2}}, so in one sense it's not too
...
{\raggedleft
 {}---George Orwell, \textit{1984}\footnoteA{Orwell, \textit{1984}.\comment{1}}
\par}
...
{\raggedleft
 {}---Ludwig Wittgenstein\footnoteA{Ludwig Wittgenstein, \textit{Philosophical Investigations},
...
{\raggedleft
 {}---Terry Pratchett, \textit{Maskerade}\footnoteA{Terry Pratchett, \textit{Maskerade}, Discworld Series (ISIS,
1997).\comment{2}}
\par}
...
the Wheel of Fortune showing various numbers.\footnoteA{Amos Tversky and Daniel Kahneman, ``Judgment
...
the United States.\footnoteA{Fritz Strack and Thomas Mussweiler,
...
seem to do so.\footnoteA{George A. Quattrone et al., ``Explorations in
...
C?''\footnoteA{Thomas Mussweiler and Fritz Strack,
...
\textit{contamination}.\footnoteA{Gretchen B. Chapman and Eric J. Johnson,
...
end of a confidence interval.\footnoteA{Tversky and Kahneman, ``Judgment Under
...
themselves.\footnoteA{Nicholas Epley and Thomas Gilovich, ``Putting
...
which is why stores keep putting them up.\footnoteA{Brian Wansink, Robert J. Kent, and Stephen J. Hoch,
``An Anchoring and Adjustment Model of Purchase
Quantity Decisions,'' \textit{Journal of Marketing
Research} 35, no. 1 (1998): 71--81,
http://www.jstor.org/stable/3151931.\comment{5}}}
...
uninterrupted, vs. 35\% when interrupted).\footnoteA{Daniel T. Gilbert, Douglas S. Krull, and Patrick S. Malone,
...
experiments by Gilbert, Tafarodi, and Malone.\footnoteA{Gilbert, Tafarodi, and Malone, ``You
...
\textit{Life of Brian}:\footnoteA{Graham Chapman et al., \textit{Monty Python's
...
true.\footnoteA{Pirsig, \textit{Zen and the Art of Motorcycle Maintenance}.\comment{1}}}
...
out:\footnoteA{Nick Bostrom, ``Existential Risks: Analyzing
Human Extinction Scenarios and Related Hazards,''
\textit{Journal of Evolution and Technology} 9 (2002),
http://www.jetpress.org/volume9/risks.html.\comment{1}}}
...
{
 As George Orwell said of cliches:\footnoteA{Orwell, ``Politics and the English
Language.''\comment{2}}}
...
from using their own. As Robert Pirsig said:\footnoteA{Pirsig, \textit{Zen and the Art of Motorcycle Maintenance}.\comment{3}}}
...
VII}:\footnoteA{Plato, \textit{Great Dialogues of Plato}, ed. Eric H.
...
{\raggedleft
 {}---Dale Griffin and Amos Tversky\footnoteA{Dale Griffin and Amos Tversky, ``The Weighing
...
Uncertain World}.\footnoteA{Dawes, \textit{Rational Choice in An Uncertain World}, 55--56.\comment{1}} Bolding added.}
...
condition.\footnoteA{Christopher K. Hsee and Howard C. Kunreuther,
...
fatal.\footnoteA{Kimihiko Yamagishi, ``When a 12.86\% Mortality
...
all) to 20 (very strong support).\footnoteA{Paul Slovic et al., ``Rational Actors or
...
Epstein:\footnoteA{Veronika Denes-Raj and Seymour Epstein,
...
quadrants.\footnoteA{Finucane et al., ``The Affect Heuristic in
...
finance.\footnoteA{Yoav Ganzach, ``Judging Risk and Return of
...
Economics.''\footnoteA{Slovic et al., ``Rational Actors or Rational
Fools.''\comment{7}}}
...
coat.\footnoteA{Christopher K. Hsee, ``Less Is Better: When
Low-Value Options Are Valued More Highly than High-Value
...
for a second-hand music dictionary:\footnoteA{Christopher K. Hsee, ``The Evaluability
...
{
 From Slovic et al.: Which would you prefer?\footnoteA{Slovic et al., ``Rational Actors or Rational
Fools.''\comment{3}}}
...
{
 Assign a dollar value to punitive damages.\footnoteA{Daniel Kahneman, David A. Schkade, and Cass R. Sunstein,
...
Practice},\footnoteA{Robert B. Cialdini, \textit{Influence: Science and Practice}
...
Makhijani, and Longo, 1991).\footnoteA{Alice H. Eagly et al., ``What Is Beautiful Is
...
1976).\footnoteA{M. G. Efran and E. W. J. Patterson, ``The
...
1976).\footnoteA{Ibid.\comment{4}} Voters can deny the impact of attractiveness
on electability all they want, but evidence has continued to confirm
its troubling presence (Budesheim and DePaola,
1994).\footnoteA{Thomas Lee Budesheim and Stephen DePaola,
...
1990).\footnoteA{Denise Mack and David Rainey, ``Female
...
Biddle, 1994).\footnoteA{Daniel S. Hamermesh and Jeff E. Biddle,
...
reviews).\footnoteA{Wilbur A. Castellow, Karl L. Wuensch, and Charles H. Moore,
...
(Stewart, 1980),\footnoteA{John E. Stewart, ``Defendants'
...
1978).\footnoteA{Richard A. Kulka and Joan B. Kessler, ``Is
...
1976)\footnoteA{Peter L. Benson, Stuart A. Karabenick, and Richard M. Lerner,
...
opinions of an audience (Chaiken, 1979) \ldots\footnoteA{Shelly Chaiken, ``Communicator Physical
...
{\raggedleft
 {}---Adam Warren, \textit{Empowered}, Vol. 1\footnoteA{Adam Warren, \textit{Empowered}, vol. 1 (Dark Horse Books,
2007).\comment{1}}
\par}
...
{
 As Sam Harris said:\footnoteA{Sam Harris, \textit{The End of Faith: Religion, Terror, and the
...
land.\footnoteA{Leon Festinger, Henry W. Riecken, and Stanley Schachter,
...
Harvey, White, Hood, and Sherif.\footnoteA{Muzafer Sherif et al., ``Study of Positive and
...
Merton\footnoteA{Zhuangzi and Thomas Merton, \textit{The Way of Chuang Tzu} (New
...
History''\footnoteA{Michael Shermer, ``The Unlikeliest Cult in
History,'' \textit{Skeptic} 2, no. 2 (1993): 74--81,
http://www.2think.org/02\_2\_she.shtml.\comment{1}}
\par}
...
conduct.\footnoteA{Solomon E. Asch, ``Studies of Independence and
...
Bond:\footnoteA{Rod Bond and Peter B. Smith, ``Culture and
...
good.''\footnoteA{Ursula K. Le Guin, \textit{The Farthest Shore} (Saga Press,
...
{\raggedleft
 {}---Sun Tzu, \textit{The Art of War}\footnoteA{Sun Tzu, \textit{The Art of War} (Cloud Hands, Inc., 2004).\comment{1}}
\par}
...
{\raggedleft
 {}---Lois McMaster Bujold, \textit{Komarr}\footnoteA{Lois McMaster Bujold, \textit{Komarr}, Miles Vorkosigan
