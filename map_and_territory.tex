...
predict your decision before it happens.\footnoteA{\textbf{Editor's Note:} For a good introduction
to Newcomb's Problem, see Holt.\footnoteB{Jim Holt, ``Thinking Inside the
Boxes,'' \textit{Slate} (2002),
http://www.slate.com/articles/arts/egghead/2002/02/thinkinginside\%5C\_the\%5C\_boxes.single.html.\comment{2}} More
generally, you can find definitions and explanations for many of the
terms in this book at the website
wiki.lesswrong.com/wiki/RAZ\_Glossary.\comment{1}}}
...
frequently.\footnoteA{Sarah Lichtenstein et al., ``Judged Frequency
...
skewed reporting frequencies in two newspapers.\footnoteA{Barbara Combs and Paul Slovic, ``Newspaper
...
concerned.''\footnoteA{Howard Kunreuther, Robin Hogarth, and Jacqueline Meszaros,
...
sense of security, leading to reduced precautions.\footnoteA{Ian Burton, Robert W. Kates, and Gilbert F. White, \textit{The
...
\textit{The Mikado}\footnoteA{William S. Gilbert and Arthur Sullivan, \textit{The Mikado},
...
presented with one proposition.\footnoteA{Tversky and Kahneman, ``Extensional Versus
...
dice.\footnoteA{Amos Tversky and Daniel Kahneman, ``Judgments
...
\$102 million.\footnoteA{Roger Buehler, Dale Griffin, and Michael Ross,
...
projects.\footnoteA{Roger Buehler, Dale Griffin, and Michael Ross,
...
accomplishments.''\footnoteA{Buehler, Griffin, and Ross, ``Inside the
...
results.\footnoteA{Ian R. Newby-Clark et al., ``People Focus on
...
shopping---where, when, and how.\footnoteA{Buehler, Griffin, and Ross, ``Inside the
...
``one day before
deadline.''\footnoteA{Ibid.\comment{6}} This is the power of
...
would perceive the sarcasm}.\footnoteA{Boaz Keysar, ``The Illusory Transparency of
...
subjects.\footnoteA{Keysar and Barr, ``Self-Anchoring in
...
the (same) message:\footnoteA{Boaz Keysar, ``Language Users as Problem
...
Mark wanted her to perceive.\footnoteA{Keysar and Barr, ``Self-Anchoring in
...
gloomy.\footnoteA{Boaz Keysar and Bridget Bly, ``Intuitions of
...
listeners understood them?\footnoteA{Boaz Keysar and Anne S. Henly,
...
that Britain would fight if any invasion occurred.\footnoteA{Keysar and Barr, ``Self-Anchoring in
...
duplicates\footnoteA{Max Tegmark, ``Parallel
...
kin.''\footnoteA{Procopius, \textit{History of the Wars}, ed. Henry B. Dewing,
...
honors.''\footnoteA{Edward Gibbon, \textit{The History of the Decline and Fall of
...
this ``belief in
belief.''\footnoteA{Daniel C. Dennett, \textit{Breaking the Spell: Religion as a
...
neutral.''\footnoteA{Paulo Freire, \textit{The Politics of Education: Culture,
...
effort.\footnoteA{Daniel T. Gilbert, Romin W. Tafarodi, and Patrick S. Malone,
...
Uncertain World}:\footnoteA{Robyn M. Dawes, \textit{Rational Choice in An Uncertain World},
...
Psychology};\footnoteA{David G. Meyers, \textit{Exploring Social Psychology} (New
...
found.\footnoteA{Paul F. Lazarsfeld, ``The American
...
opposite.\footnoteA{Daphna Baratz, \textit{How Justified Is the
...
soldiers in a line.\footnoteA{Judea Pearl, \textit{Probabilistic Reasoning in Intelligent
...
{\raggedleft
 {}---Lord Kelvin\footnoteA{Silvanus Phillips Thompson, \textit{The Life of Lord Kelvin}
...
20\%.\footnoteA{Peter Cathcart Wason, ``On the Failure to
...
describes an experiment by Tversky:\footnoteA{Dawes, \textit{Rational Choice in An Uncertain World}; Yaacov
...
doi:10.1002/bdm.434.\comment{1}}\supercomma\footnoteA{Amos Tversky and Ward Edwards, ``Information
...
risks.''\footnoteA{Eliezer Yudkowsky, ``Cognitive Biases
...
a state of mind} using a semantic network:\footnoteA{Drew McDermott, ``Artificial Intelligence
...
enough to be wrong.\footnoteA{Richard Rorty, ``Out of the Matrix: How the
