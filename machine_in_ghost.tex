...
Machine.''\footnoteA{Gilbert Ryle, \textit{The Concept of Mind} (University of
...
exponential technological progress thesis.\footnoteA{Irving John Good, ``Speculations Concerning
...
AI.\footnoteA{Nick Bostrom, \textit{Superintelligence: Paths, Dangers,
...
\textit{Artificial Intelligence: A Modern Approach}.\footnoteA{Stuart J. Russell and Peter Norvig, \textit{Artificial
...
Risks}.\footnoteA{Bostrom and \'Cirkovi\'c, \textit{Global Catastrophic Risks}.\comment{5}} The most extreme of these are the
\textit{existential risks}, risks that could result in the permanent
stagnation or extinction of humanity.\footnoteA{An example of a possible existential risk is the
...
artificial intelligence.''\footnoteA{Nick Bostrom and Eliezer Yudkowsky, ``The
...
should play with mice.''\footnoteA{Francis Darwin, ed., \textit{The Life and Letters of Charles
...
tails.''\footnoteA{George C. Williams, \textit{Adaptation and Natural Selection: A
...
``Darwin's
Bulldog,'' put it:\footnoteA{Thomas Henry Huxley, \textit{Evolution and Ethics and Other
...
gene pool.\footnoteA{Dan Graur and Wen-Hsiung Li, \textit{Fundamentals of Molecular
...
occasion.\footnoteA{John B. S. Haldane, ``A Mathematical Theory of
...
restraint.\footnoteA{David Sloan Wilson, ``A Theory of Group
...
numbers of adults per subpopulation.\footnoteA{Michael J. Wade, ``Group selections among
...
Culture''\footnoteA{John Tooby and Leda Cosmides, ``The
...
{\raggedleft
 ...
 summarizing Crawford et al.\footnoteA{Robert Wright, \textit{The Moral Animal: Why We Are the Way We
...
especially female larvae.\footnoteA{Wade, ``Group selections among laboratory
...
{
 Miyamoto Musashi said:\footnoteA{Miyamoto Musashi, \textit{Book of Five Rings} (New Line
...
{
 C. J. Cherryh said:\footnoteA{Carolyn J. Cherryh, \textit{The Paladin} (Baen, 2002).\comment{2}}}
...
Smullyan.}\textit{\footnoteA{Raymond M. Smullyan, \textit{What Is the Name of This Book?:
...
{\raggedleft
 {}---Charles Sanders Peirce\footnoteA{Charles Sanders Peirce, \textit{Collected Papers} (Harvard
...
``prototype
effects.''\footnoteA{Eleanor Rosch, ``Principles of
...
times are faster for more central examples.\footnoteA{George Lakoff, \textit{Women, Fire, and Dangerous Things: What
...
make more sense.\footnoteA{Jerrold Sadock, ``Truth and
...
is to Mexico.\footnoteA{Amos Tversky and Itamar Gati, ``Studies of
...
ducks on an island, than from ducks to robins.\footnoteA{Lance J. Rips, ``Inductive Judgments about
...
adapted.\footnoteA{Tom M. Mitchell, \textit{Machine Learning} (McGraw-Hill
...
Debate.}\footnoteA{Stephen M. Kosslyn, \textit{Image and Brain: The Resolution of
...
Graboys 1978;\footnoteA{Ward Casscells, Arno Schoenberger, and Thomas Graboys,
``Interpretation by Physicians of Clinical Laboratory
Results,'' \textit{New England Journal of Medicine}
299 (1978): 999--1001.\comment{1}} Eddy 1982;\footnoteA{David M. Eddy, ``Probabilistic Reasoning in
...
1982).\comment{2}}
Gigerenzer and Hoffrage 1995;\footnoteA{Gerd Gigerenzer and Ulrich Hoffrage, ``How to
...
reasoning.\footnoteA{Ibid.\comment{4}} The \textit{least} evocative phrasing
...
be measured in decibels.\footnoteA{Edwin T. Jaynes, ``Probability Theory, with
