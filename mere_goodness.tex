...
progress.\footnoteA{One example of a transhumanist argument is:
...
``gift.''\footnoteB{Nick Bostrom, ``A History of Transhumanist
Thought,'' \textit{Journal of Evolution and
Technology} 14, no. 1 (2005): 1--25,
http://www.nickbostrom.com/papers/history.pdf.\comment{2}}\supercomma\footnoteB{Michael Sandel, ``What's Wrong
...
debate.\footnoteB{Nick Bostrom and Julian Savulescu, ``Human
Enhancement Ethics: The State of the Debate,'' in
\textit{Human Enhancement}, ed. Nick Bostrom and Julian Savulescu
(2009).\comment{4}}\comment{1}} Transhumanism occasions a number of
...
a major topic of discussion.)\footnoteA{Harris, \textit{The End of Faith: Religion, Terror, and the
...
was feeling mischievous\footnoteA{Other mischievous questions to ask self-proclaimed Selfishes:
...
Stupidity.''\footnoteA{McDermott, ``Artificial Intelligence Meets
...
Pinker's \textit{The Blank Slate.}\footnoteA{Steven Pinker, \textit{The Blank Slate: The Modern Denial of
...
Inference.}\footnoteA{Pearl, \textit{Probabilistic Reasoning in Intelligent
...
make people let the AI out of the box\footnoteA{Just kidding.\comment{1}}{}---but that
...
wrong \textit{about} anything.\footnoteA{Rorty, ``Out of the Matrix: How the Late
...
Machines\footnoteA{Bill Hibbard, ``Super-Intelligent
...
{
 When I mentioned (sec. 7.2)\footnoteA{Eliezer Yudkowsky, ``Artificial Intelligence
...
benefits.\footnoteA{Eliezer Yudkowsky, \textit{Timeless Decision Theory},
...
Utopia is impossible in literature and reality:\footnoteA{George Orwell, ``Why Socialists
...
\textit{feasibility} part, when he says:\footnoteA{David Pearce, \textit{The Hedonistic Imperative},
...
\$78, and \$88.\footnoteA{William H. Desvousges et al., \textit{Measuring Nonuse Damages
...
particular region of Ontario,\footnoteA{Daniel Kahneman, ``Comments by Professor
...
area.\footnoteA{Daniel L. McFadden and Gregory K. Leonard,
...
escape.''\footnoteA{Kahneman, Ritov, and Schkade, ``Economic
...
willingness-to-pay from \$3.78 to \$15.23.\footnoteA{Richard T. Carson and Robert Cameron Mitchell,
...
10.\footnoteA{Jonathan Baron and Joshua D. Greene,
...
people per year.\footnoteA{David Fetherstonhaugh et al., ``Insensitivity
...
experimentally exposed, in 1953.\footnoteA{Maurice Allais, ``Le Comportement de
...
2.\footnoteA{Sarah Lichtenstein and Paul Slovic,
...
transcript:\footnoteA{William Poundstone, \textit{Priceless: The Myth of Fair Value
(and How to Take Advantage of It)} (Hill \& Wang, 2010).\comment{2}}\supercomma\footnoteA{Sarah Lichtenstein and Paul Slovic, eds., \textit{The
...
\$200.\footnoteA{Kahneman and Tversky, ``Prospect Theory: An
...
contributions to the entire group.\footnoteA{Paul Slovic, ``Numbed by
...
him and shook his hand.''\footnoteA{Richard Rhodes, \textit{The Making of the Atomic Bomb} (New
...
words of Miyamoto Musashi:\footnoteA{Musashi, \textit{Book of Five Rings}.\comment{1}}}
...
Problem}\footnoteA{Richmond Campbell and Lanning Snowden, eds., \textit{Paradoxes
...
major standard positions.\footnoteA{Marion Ledwig, ``Newcomb's
...

{
 You can win with a long weapon, and yet you can also win with a
short weapon. In short, the Way of the Ichi school is the spirit of
winning, whatever the weapon and whatever its size.\footnoteA{Musashi, \textit{Book of Five Rings}.\comment{3}}}
...
Decision Theory}:\footnoteA{James M. Joyce, \textit{The Foundations of Causal Decision
...
``Timeless Decision
Theory.''\footnoteA{Yudkowsky, \textit{Timeless Decision Theory}.\comment{5}} The cryptographer Wei
...
Dilemmas''\footnoteA{Daniel Hintze, ``Problem Class Dominance in
Predictive Dilemmas,'' Honors thesis (2014).\comment{6}} and Nate Soares and
Benja Fallenstein's ``Toward Idealized
Decision Theory.''\footnoteA{Nate Soares and Benja Fallenstein, ``Toward
...
be.''\footnoteA{Patricia C. Hodgell, \textit{Seeker's Mask}
...
ball.''\footnoteA{Cleaver, \textit{Immediate Fiction: A Complete Writing
...
away.''\footnoteA{Antoine de Saint-Exupery, \textit{Terre des Hommes} (Paris:
...
Rings}:\footnoteA{Musashi, \textit{Book of Five Rings}.\comment{4}}}
