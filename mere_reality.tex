...
\begin{equation*}
 ((X\text{ and }Y\text{ and }Z\text{ and }\ldots)\text{ or }(X\text{ and }\lnot Y\text{ and }Z\text{ and }\ldots)
\text{ or }\ldots).
\end{equation*}
...
\begin{align*}
 ...
 \text{Payoff} &= P(\text{winner}) \\
 &= \text{amount of play money} \\
   & \text{allocated to winning
color.}
\end{align*}
...
$P(\text{blue}_{2}|\text{green}_{1})$.\footnote{Don't remember how to read $P(A|B)$? See
